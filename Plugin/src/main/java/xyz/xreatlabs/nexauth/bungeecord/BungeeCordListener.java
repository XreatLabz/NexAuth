...
public class BungeeCordListener extends AuthenticListeners<BungeeCordNexAuth, ProxiedPlayer, ServerInfo> implements Listener {

    public BungeeCordListener(BungeeCordNexAuth plugin) {
        super(plugin);
    }
