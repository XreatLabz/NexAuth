...
import xyz.xreatlabs.nexauth.common.authorization.ProfileConflictResolutionStrategy;
...
public class AuthenticListeners<Plugin extends AuthenticNexAuth<P, S>, P, S> {
