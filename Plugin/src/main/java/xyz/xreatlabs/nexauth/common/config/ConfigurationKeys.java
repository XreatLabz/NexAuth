...
public class ConfigurationKeys {
    ...
    public static final ConfigurationKey<Boolean> ALLOW_PROXY_CONNECTIONS = new ConfigurationKey<>(
            ...
            """
                    ...
                    Verifies whether the IP the players had used when authenticating to Mojang matches the IP they are connecting from. Disabling this may break NexAuth if the server is running under a reverse proxy/VPN.
                    """,
            ConfigurateHelper::getBoolean
    );
